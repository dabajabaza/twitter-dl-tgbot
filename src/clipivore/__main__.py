"""Process entrypoint: long polling. Run as ``python -m clipivore``."""
...
from clipivore.bot.middlewares import AuthMiddleware, PrivateChatOnlyMiddleware
from clipivore.bot.storage import NoStorage
